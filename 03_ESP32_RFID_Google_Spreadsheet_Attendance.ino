...
const char* ssid ="CMF";  //--> Your wifi name
const char* password ="12345678"; //--> Your wifi password
//----------------------------------------

// Google script Web_App_URL.
String Web_App_URL = "https://script.google.com/macros/s/AKfycbxnenBd4NC3HPYaDztq6gvq-39q4rG19Wyc8TIGZZ6_I55Lb1G2x7B3V5FRleEwbfp2/exec";
